...
//+
Transfinite Curve {22, 24, 26} = nVert Using Progression rVert; //Vertical far field
//+
Transfinite Curve {28, 30} = nVert Using Progression rVertWake; //Vertical wake far field 
//+
Transfinite Curve {23, 25, 27} = nVertFloor Using Bump rVertBump; //Vertical far field floor
//+
Transfinite Curve {29, 31} = nVertFloor Using Bump rVertWakeBump; //Vertical wake far field floor
//+
Transfinite Curve {21, 2, 40} = nLE Using Progression 1; //Vertical leading edge
//+
Transfinite Curve {38, 39, 34, 35} = nVertWake Using Progression rVertAirfoil; //Vertical airfoil
//+
Transfinite Curve {36, 37, 33, 32} = nVertWake Using Progression rVertAirfoil; //Vertical wake
//+
Transfinite Curve {15, 11, 7, 3} = nHoriInlet Using Progression rHoriInlet; //Horizontal inlet
//+
Transfinite Curve {16, 12, 41, 42, 8, 4} = nHoriAirfoil Using Progression 1; //Horizontal airfoil
//+
Transfinite Curve {17, 13, 19, 9, 5} = nHoriWake Using Progression rHoriWake;//Horizontal wake

...
x0 = 2.0;
y1 = 1.0;
x1 = - inlet_dist * (2*y1)/inlet_h;

P1 = Point{1};
xte = P1[0];
yte = P1[1];
y2 = y1;
x2 = xte - (xte-x0)*(y2-yte)/((inlet_h/2)-yte);
dyte = 0.8;
...
//+
Point(160) = {-inlet_dist, inlet_h/2, 0, 1.0};
//+
Point(161) = {-inlet_dist, -inlet_h/2, 0, 1.0};
//+
Point(162) = {length - inlet_dist, -inlet_h/2, 0, 1.0};
//+
Point(163) = {length - inlet_dist, inlet_h/2, 0, 1.0};
//+
Point(164) = {x0, inlet_h/2, 0, 1.0};
//+
Point(165) = {x0, -inlet_h/2, 0, 1.0};
//+
Point(166) = {x1, y1, 0, 1.0};
//+
Point(167) = {x1, -y1, 0, 1.0};
//+
Point(168) = {x2, y2, 0, 1.0};
//+
Point(169) = {x2, -y2, 0, 1.0};
//+
Point(170) = {length - inlet_dist, y2 + dyte, 0, 1.0};
//+
Point(171) = {length - inlet_dist, -y2 + dyte, 0, 1.0};
//+
Point(172) = {length - inlet_dist, yte + dyte, 0, 1.0};
//+
Circle(2) = {161, 80, 160};
//+
Circle(3) = {167, 80, 166};
...
//+
Transfinite Curve {2, 3, 25} = 34 Using Progression 1;  //Curve inlet
//+
...
Plane Surface(1) = {1};
//+
Curve Loop(2) = {3, -4, 25, 5};
//+
Plane Surface(2) = {2};
//+
Curve Loop(3) = {27, 4, 12, -6};
//+
Plane Surface(3) = {3};
//+
Curve Loop(4) = {26, 7, -13, -5};
//+
Plane Surface(4) = {4};
//+
Curve Loop(5) = {12, 10, -14, -8};
//+
Plane Surface(5) = {5};
//+
Curve Loop(6) = {13, 11, -15, -9};
//+
Plane Surface(6) = {6};
//+
Curve Loop(7) = {6, 18, -23, -17};
//+
Plane Surface(7) = {7};
//+
Curve Loop(8) = {17, 21, -16, -7};
//+
Plane Surface(8) = {8};
//+
Curve Loop(9) = {16, 22, -20, -11};
//+
Plane Surface(9) = {9};
//+
Curve Loop(10) = {18, 24, -19, -10};
//+
Plane Surface(10) = {10};
//+
...
//+
Physical Surface("Side", 251) = {49, 71, 247, 225, 181, 203, 159, 137, 115, 93, 10, 7, 8, 9, 1, 5, 3, 4, 6, 2};
//+

...
Point(190) = {x0, -(h+dy), 0, 1.0};
Point(191) = {0.2109, -(h+dy), 0, 1.0};
...
Line(41) = {90, 169};
//+
Circle(42) = {169, 188, 168};
//+
Split Curve {1} Point {70, 90, 104, 1};
//+
Line(47) = {189, 190};
//+
Line(48) = {190, 191};
...
//+
Transfinite Curve {24, 25, 26, 27, 28} = 100 Using Progression 1.015;     //V Top far field
//+
Transfinite Curve {23, 29, 30, 31, 32} = 100 Using Progression 1.02;  //V Middle
//+
Transfinite Curve {22, 42} = nVLE Using Progression 1.02;             //V Leading Edge Bottom
//+
Transfinite Curve {43} = nVLE Using Progression 1/1.018;               //V Stagnation point
//+
Transfinite Curve {40, 41, 39, 34, 33} = nVBottom Using Progression 1.02;
//+
Transfinite Curve {35, 37} = nVBottom Using Progression 1;
//+
Transfinite Curve {36, 38} = nVBottom Using Bump 1/4;
//+
Transfinite Curve {41, 39, 34} = nVBottom Using Bump 1/7;             //V Bottom airfoil
//+
Transfinite Curve {15, 47} = nHInlet Using Progression 1/1.01;      //H Inlet
//+
Transfinite Curve {11, 7 ,3} = nHInlet Using Progression 1/1.01;      //H Inlet
//+
Transfinite Curve {44} = nHBottomAirfoil Using Progression 1.;
//+
Transfinite Curve {48, 16} = nHBottomAirfoil Using Progression 1.0;
//+
Transfinite Curve {17, 45, 49} = 280 Using Progression 1.006;
//+
Transfinite Curve {12, 8, 4} = 200 Using Progression 1.005;           //H Top Airfoil
//+
Transfinite Curve {46} = 200 Using Bump 1/3.5;   
//+
Transfinite Curve {18, 20, 13, 9, 5, 50} = 100 Using Progression 1.01;    // H Wake close
//+
Transfinite Curve {19, 21, 14, 10, 6, 51} = 100 Using Progression 1.025;      // H Wake far field
//+
Transfinite Curve {52, 53, 54, 55, 56, 57} = 184 Using Progression 1.005;      // V Floor
//+
Curve Loop(1) = {15, 42, -11, -22};
//+
Plane Surface(1) = {1};
//+
Curve Loop(2) = {29, -7, -23, 11};
//+
Plane Surface(2) = {2};
//+
Curve Loop(3) = {24, 3, -25, -7};
//+
Plane Surface(3) = {3};
//+
Curve Loop(4) = {41, 42, -40, 43};
//+
Plane Surface(4) = {4};
//+
Curve Loop(5) = {16, -39, -44, 41};
//+
Plane Surface(5) = {5};
//+
Curve Loop(6) = {45, 34, -17, -39};
//+
Plane Surface(6) = {6};
//+
Curve Loop(7) = {46, 40, 12, -33};
//+
Plane Surface(7) = {7};
//+
Curve Loop(8) = {29, 8, -30, -12};
//+
Plane Surface(8) = {8};
//+
Curve Loop(9) = {8, 26, -4, -25};
//+
Plane Surface(9) = {9};
//+
Curve Loop(10) = {5, -27, -9, 26};
//+
Plane Surface(10) = {10};
//+
Curve Loop(11) = {9, -31, -13, 30};
//+
Plane Surface(11) = {11};
//+
Curve Loop(12) = {33, 13, -35, -20};
//+
Plane Surface(12) = {12};
//+
Curve Loop(13) = {34, 18, -36, -20};
//+
Plane Surface(13) = {13};
//+
Curve Loop(14) = {19, -38, -21, 36};
//+
Plane Surface(14) = {14};
//+
Curve Loop(15) = {14, -37, -21, 35};
//+
Plane Surface(15) = {15};
//+
Curve Loop(16) = {32, -10, -31, 14};
//+
Plane Surface(16) = {16};
//+
Curve Loop(17) = {27, 6, -28, -10};
//+
Plane Surface(17) = {17};
//+
...
//+
Curve Loop(18) = {15, -53, -47, 52};
//+
Plane Surface(18) = {18};
//+
Curve Loop(19) = {16, -54, -48, 53};
//+
Plane Surface(19) = {19};
//+
Curve Loop(20) = {17, -55, -49, 54};
//+
Plane Surface(20) = {20};
//+
Curve Loop(21) = {18, -56, -50, 55};
//+
Plane Surface(21) = {21};
//+
Curve Loop(22) = {19, -57, -51, 56};
//+
Plane Surface(22) = {22};
//+
...
//+
Recombine Surface {3, 2, 1, 9, 10, 17, 16, 11, 8, 7, 4, 5, 6, 13, 12, 15, 14, 18, 19, 20, 21, 22};


//+
Extrude {0, 0, 1} {
  Surface{3}; Surface{2}; Surface{1}; Surface{9}; Surface{10}; Surface{17}; Surface{16}; Surface{11}; Surface{8}; Surface{4}; Surface{7}; Surface{5}; Surface{6}; Surface{13}; Surface{12}; Surface{15}; Surface{14}; Surface{18}; Surface{19}; Surface{20}; Surface{21}; Surface{22}; Layers {1}; Recombine;
}
...
//+
Physical Volume("Fluid", 542) = {1, 4, 5, 6, 7, 16, 17, 22, 8, 15, 14, 21, 13, 20, 11, 9, 10, 12, 19, 18, 3, 2};
//+
Physical Surface("Inlet", 543) = {66, 96, 122, 452};
//+
Physical Surface("Floor", 544) = {448, 470, 492, 514, 536};
//+
Physical Surface("Outlet", 545) = {184, 198, 400, 422, 532};
//+
Physical Surface("Top", 546) = {70, 140, 154, 180};
//+
Physical Surface("Side", 547) = {3, 9, 10, 17, 2, 8, 1, 18, 4, 19, 5, 7, 6, 20, 13, 12, 11, 16, 15, 14, 21, 22, 431, 409, 211, 189, 365, 387, 233, 167, 255, 145, 79, 101, 123, 453, 277, 475, 321, 497, 343, 519, 541, 299};
//+
Physical Surface("Airfoil", 548) = {286, 330, 276, 316};
